...
function liveSearch() {
    // Locate the panel elements
    let panel = document.querySelectorAll('.panel')
    // Locate the search input
    let search_query = document.getElementById("searchbox").value;
    // Loop through the panel
    for (var i = 0; i < panel.length; i++) {
        // If the text is within the panel...
...
function addActionPanel(mainElement, action) {
    ...
    panel.innerHTML += '<div class="line"><span class="name">Fork of:</span><span class="value"><a href="https://github.com/' + action.forkedfrom + '">' + action.forkedfrom + '</a></span></div>';
